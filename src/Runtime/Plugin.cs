...
#pragma warning restore CS0162
        ...
        private static void LogInstallDiagnostics()
        {
            ...
            string primaryRuntimePath = System.IO.Path.Combine(Paths.PluginPath, "DINOForge.Runtime.dll");
            string legacyRuntimePath = System.IO.Path.Combine(Paths.BepInExRootPath, "ecs_plugins", "DINOForge.Runtime.dll");
            string backupRuntimePath = System.IO.Path.Combine(Paths.PluginPath, "DINOForge.Runtime.dll.bak");
            ...
            if (System.IO.File.Exists(legacyRuntimePath))
            {
            ...
            if (System.IO.File.Exists(primaryRuntimePath) && System.IO.File.Exists(legacyRuntimePath))
            {
            ...
            if (System.IO.File.Exists(backupRuntimePath))
            {
